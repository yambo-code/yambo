...
#
ACX_STRIPE_SUBPATH($HDF5_LIBS_F,"LIB")
HDF5_LIBS_F_R=$STRIPE
ACX_STRIPE_SUBPATH($HDF5_INCS_F,"INC")
HDF5_INCS_F_R=$STRIPE
AC_SUBST(HDF5_LIBS_F_R)
AC_SUBST(HDF5_INCS_F_R)
#
ACX_STRIPE_SUBPATH($HDF5_LIBS_C,"LIB")
HDF5_LIBS_C_R=$STRIPE
ACX_STRIPE_SUBPATH($HDF5_INCS_C,"INC")
HDF5_INCS_C_R=$STRIPE
AC_SUBST(HDF5_LIBS_C_R)
AC_SUBST(HDF5_INCS_C_R)
#
