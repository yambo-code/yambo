...
# ============================================================================
# DEBUG
AC_ARG_ENABLE(keep-objects, AS_HELP_STRING([--enable-keep-objects],
...
#
AC_ARG_ENABLE(time-profile, AS_HELP_STRING([--enable-time-profile],
...
# Memory Profiling 
#
AC_ARG_ENABLE(memory-profile, AS_HELP_STRING([--enable-memory-profile],
...
# Verbose compilation
#
AC_ARG_ENABLE(msgs-comps, AS_HELP_STRING([--enable-msgs-comps],
...
# EDITOR
#
AC_ARG_WITH(editor, AS_HELP_STRING([--with-editor=<exe>],
