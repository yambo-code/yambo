clean:     clean_Ydriver clean_ypp clean_src clean_interfaces clean_stamps clean_bin
...
clean_interfaces: clean_stamps clean_driver
	@(TARG="";MSG="interfaces";EXTS="\.f90 \.o \.lock \.tmp_source";WDIR="$(topdir)";\
	 for FOLD in `cat config/stamps_and_lists/active_directories.list|grep interfaces`;do TARG="$$TARG $$FOLD";done;\
         $(clean_dir_driver);$(clean_lib_driver);$(clean_mod_driver))
clean_ypp: clean_stamps clean_driver
	@(TARG="";MSG="ypp";EXTS="\.f90 \.o \.lock \.tmp_source";WDIR="$(topdir)";\
...
clean_src: clean_stamps clean_driver
	@(TARG="";MSG="src";EXTS="\.f90 \.o \.lock \.tmp_source";WDIR="$(topdir)";\
