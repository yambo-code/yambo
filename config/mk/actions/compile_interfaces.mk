a2y: ext-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(topdir)/src" ; ADF="-D_a2y"; $(mk_src)
...
c2y: ext-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(topdir)/src" ; ADF="-D_c2y"; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(topdir)/interfaces" ; $(mk_internal_lib)
...
e2y: ext-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(topdir)/src" ; ADF="-D_e2y"; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(topdir)/interfaces" ; $(mk_internal_lib)
