a2y: ext-libs int-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(compdir)/lib" ; $(mk_internal_lib)
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(compdir)/src" ; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(compdir)/interfaces" ; $(mk_internal_lib)
	@+X2DO="a2y"; XPATH="interfaces/a2y"; VPATH="$(compdir)/interfaces/a2y"; XLIBS="$(2YLIBS_LD)"; DRILIBS="$(YLIBDRIVER_LD)"; $(mk_yambo)
c2y: ext-libs int-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(compdir)/src" ; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(compdir)/interfaces" ; $(mk_internal_lib)
	@+X2DO="c2y"; XPATH="interfaces/c2y"; VPATH="$(compdir)/interfaces/c2y"; XLIBS="$(2YLIBS_LD)"; DRILIBS="$(YLIBDRIVER_LD)"; $(mk_yambo)
ifeq ($(do_p2y),yes)
p2y: ext-libs int-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(compdir)/src" ; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(compdir)/interfaces" ; $(mk_internal_lib)
	@+X2DO="p2y" ; XPATH="interfaces/p2y"; VPATH="$(compdir)/interfaces/p2y"; XLIBS="$(2YLIBS_LD)"; DRILIBS="$(YLIBDRIVER_LD)"; ADF="$(p2ycpp)"; $(mk_yambo) ;
endif
ifeq ($(do_e2y),yes)
e2y: ext-libs int-libs
	...
	@+LIBS2DO="$(2YLIBS)"; XPATH="src" ; VPATH="$(compdir)/src" ; $(mk_src)
	@+LIBS2DO="int_modules"; DIR2GO="interfaces" ; VPATH="$(compdir)/interfaces" ; $(mk_internal_lib)
	@+X2DO="e2y" ; XPATH="interfaces/e2y"; VPATH="$(compdir)/interfaces/e2y"; XLIBS="$(2YLIBS_LD)"; DRILIBS="$(YLIBDRIVER_LD)"; $(mk_yambo) ;
endif
