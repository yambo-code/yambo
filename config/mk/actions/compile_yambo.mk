yambo: ext-libs
	...
	@+LIBS2DO="driver"; ADF="-D_yambo_driver -D_yambo"; $(mk_external_yambo_lib)
...
yambo_magnetic: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_MAGNETIC -D_SC -D_yambo"; $(mk_driver_src)
...
yambo_electric: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_ELECTRIC -D_SC -D_yambo"; $(mk_driver_src)
...
yambo_kerr: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_RT -D_ELPH -D_KERR -D_yambo"; $(mk_driver_src)
...
yambo_sc: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_SC -D_yambo"; $(mk_driver_src)
...
yambo_pl: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_RT -D_SC -D_ELPH -D_PL -D_yambo"; $(mk_driver_src)
...
yambo_rt: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_RT -D_ELPH -D_yambo"; $(mk_driver_src)
...
yambo_nl: ext-libs
	...
	@+ADF="-D_DOUBLE -D_SLEPC_OFF -D_NL -D_RT -D_ELPH -D_yambo"; $(mk_driver_src)
...
yambo_ph: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_ELPH -D_yambo"; $(mk_driver_src)
...
yambo_qed: ext-libs
	@+LIBS2DO="$(INT_LIBS)"; DIR2GO="lib" ; VPATH="$(topdir)/lib" ; $(mk_internal_lib)
	@+ADF="-D_QED -D_RT -D_ELPH -D_yambo"; $(mk_driver_src)
