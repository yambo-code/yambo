...
yambo:
	...
	@+X2DO="yambo";BASE=ymain;XLIBS="$(MAIN_LIBS_LD)";ADF="";$(todo_driver)
	@+X2DO="yambo";BASE=ymain;XLIBS="$(MAIN_LIBS_LD)";ADF="";$(mk_exe)
...
yambo_ph: yambo
	...
	@+X2DO="yambo_ph";BASE=ymain_ph;XLIBS="$(PJ_PHLIBS_LD)";ADF="";$(todo_driver)
	@+X2DO="yambo_ph";BASE=ymain_ph;XLIBS="$(PJ_PHLIBS_LD)";ADF="";$(mk_exe)
...
yambo_sc: yambo ham-libs
	...
	@+X2DO="yambo_sc";BASE=ymain_sc;XLIBS="$(PJ_SCLIBS_LD)";ADF="";$(todo_driver)
	@+X2DO="yambo_sc";BASE=ymain_sc;XLIBS="$(PJ_SCLIBS_LD)";ADF="";$(mk_exe)
...
yambo_rt: yambo ham-libs
	...
	@+X2DO="yambo_rt";BASE=ymain_rt;XLIBS="$(PJ_RTLIBS_LD)";ADF="";$(todo_driver)
	@+X2DO="yambo_rt";BASE=ymain_rt;XLIBS="$(PJ_RTLIBS_LD)";ADF="";$(mk_exe)
...
yambo_nl: yambo ham-libs
	...
	@+X2DO="yambo_nl";BASE=ymain_nl;XLIBS="$(PJ_NLLIBS_LD)";ADF="";$(todo_driver)
	@+X2DO="yambo_nl";BASE=ymain_nl;XLIBS="$(PJ_NLLIBS_LD)";ADF="";$(mk_exe)
