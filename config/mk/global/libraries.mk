...
YAMBO_INT_LIBS= $(YIO_DIR)
YLIBIO        = modules $(YIO_DIR)
YLIBIO_LD     = $(YLIBIO)
#
# Yambo folders 
#===============
#
BASIC_LIBS   = driver tools modules memory allocations matrices linear_algebra parallel parser communicate output common timing $(YIO_DIR) io $(IO_MODE) \
               xc_functionals interface stop_and_restart wf_and_fft bz_ops coulomb
BASIC_LIBS_LD= driver tools memory allocations communicate modules matrices linear_algebra bz_ops parallel parser output common timing $(YIO_DIR) io $(IO_MODE) \
...
#=====================================
#
2Y_LIBS       = driver tools modules memory allocations matrices linear_algebra parallel parser communicate output common timing $(YIO_DIR) io $(IO_MODE) \
                setup interface stop_and_restart bz_ops 
2Y_LIBS_LD    = driver tools memory allocations communicate modules matrices linear_algebra parallel parser output common timing $(YIO_DIR) io $(IO_MODE) \
                setup interface stop_and_restart bz_ops 
#
# YPP folders 
#===============
