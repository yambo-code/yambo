...
#===============
#
Y_LIBS       = driver tools Ymodules memory allocations matrices linear_algebra parallel parser communicate output common timing Yio io $(IO_MODE) \
               gpu_test_mod gpu_test xc_functionals interface stop_and_restart wf_and_fft bz_ops coulomb interpolate qp_control setup \
...
Y_LIBS_LD    = tools memory allocations communicate Ymodules matrices linear_algebra bz_ops parallel parser output common timing Yio io $(IO_MODE) \
               gpu_test_mod gpu_test xc_functionals interface stop_and_restart wf_and_fft coulomb interpolate real_time_control qp_control setup \
...
#===============
#
YPP_LIBS     = YPPmodules interface qp plotting k-points symmetries bits electrons dipoles el-ph real_time excitons
