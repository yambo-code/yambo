...
SURF_PROJ = yambo_surf
MAIN     = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RT_PROJ)  $(NL_PROJ) $(SURF_PROJ)
ALL      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(GPL) $(NL_PROJ) $(SURF_PROJ) $(GPL)
BROKEN   = yambo_phdyn
SCRIPTS  = ydb.pl
EXE      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(GPL) $(NL_PROJ) $(SURF_PROJ) $(BROKEN) $(SCRIPTS)
