...
MAIN     = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RT_PROJ)         $(MOD_PROJ)  $(NL_PROJ)
ALL      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(GPL) $(MOD_PROJ)  $(NL_PROJ)
BROKEN   = yambo_phdyn
SCRIPTS  = ydb.pl
EXE      = $(CORE) $(PH_PROJ) $(SC_PROJ) $(RTE_PROJ) $(GPL) $(NL_PROJ) $(MOD_PROJ) $(BROKEN) $(SCRIPTS)
