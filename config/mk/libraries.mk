EXT_LIBS      = libxc devxlib lapack fftw fftqe yaml futile iotk hdf5 pnetcdf netcdf etsf_io blacs scalapack petsc slepc
...
BASIC_LIBS   = driver tools modules memory matrices linear_algebra parallel parser communicate common timing Yio io \
               xc_functionals interface stop_and_restart wf_and_fft bz_ops coulomb gpu_test
BASIC_LIBS_LD= tools memory Yio communicate modules matrices linear_algebra bz_ops parallel parser communicate common timing Yio io \
               xc_functionals interface stop_and_restart wf_and_fft coulomb gpu_test
