...
*/
 static Ldes opts[] = { /* Int Real Ch (dummy) Parallel_option*/
  ...
  {"excitons", "e","Excitons  [(s)ort,(sp)in,(a)mp,(w)ave,(e)lias,(g)kkp]",0,0,1,0,0}, 
...
#if defined _YPP_RT
  {"RealTime","t","Real Time [(X)response,(d)os,(lb)LifeBands,(ob)OccBands,(op)OccPlot,(of)OccFit]",0,0,1,0,0}, 
#endif
