...
# Projects 
#==========
for PJ in _SC _RT _RT_SCATT _ELPH _ELPH_ITERATIVE _PHEL _NL _FL _QED _YPP_ELPH _YPP_RT _YPP_NL _YPP_FL _YPP_SC _yambo _ypp _a2y _p2y _c2y _DOUBLE _MODELS
do
 #
