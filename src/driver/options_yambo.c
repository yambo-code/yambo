...
void options_yambo(struct options_struct *options, int *i_opt)
{
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[i_desc],
           "<string>=(p)PA/(m)PA/(c)HOSEX/(r)eal-axis");
#if defined _ELPH
    i_desc = i_desc + 1;
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[1],
           "<string>=(n)ewton [order 1]/(s)ecant [e-e scattering]");
#if defined _PHEL
    strcpy(options[*i_opt].long_desc[2],
           "<string>=(n)ewton [order 2] [p-e scattering]");
#endif
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[1],
           "<string>=b for Transition-Space Bethe-Salpeter");
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(s)static/(p)PA/m(PA)/(d)ynamical dielectric matrix");
    strcpy(options[*i_opt].long_desc[1],
           "<string>=(X) dynamical response matrix");
    options[*i_opt].char_var = 1;
    *i_opt = *i_opt + 1;
