...
void options_ypp(struct options_struct *options, int *i_opt)
{
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(k)pt,(q)pt,(s)hifted,(h)igh symmetry,(r)andom,r(e)gular");
    ...
    */
    *i_opt = *i_opt + 1;
    options[*i_opt].short_desc =
        "Remove symmetries not consistent with an external perturbation";
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(g)enerate-modify/(m)erge/(e)xpand");
    strcpy(options[*i_opt].long_desc[1],
           "         (e)xpand uses the symmetries to generate a BZ-expanded QP "
           "database");
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(w)ave,(d)ensity,(m)ag,do(s),(b)ands,(c)urrent,angu(l)ar,("
           "p)osition");
#else
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(w)ave,(d)ensity,(m)ag,do(s),(b)ands,(c)urrent");
#endif
...
#if defined _ELPH
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(s)ort,(sp)in,(a)mplitude,(w)ave,(i)nterpolate,");
    strcpy(options[*i_opt].long_desc[1],
           "         (e)lias,(g)kkp,(p)h-assisted dos");
#else
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(s)ort,(sp)in,(a)mplitude,(w)ave,(i)nterpolate");
#endif
    ...
    *i_opt = *i_opt + 1;
    ...
    options[*i_opt].bin = "ypp";
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(exc)itonic,(ip)independent-particle");
#if defined _YPP_RT
    strcpy(options[*i_opt].long_desc[0],
           "<string>=(exc)itonic,(ip)independent-particle,(m)ask");
#endif
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[3],
           "(a) absorption amends the Kubo expression with the time-dependent "
           "occupations");
    strcpy(options[*i_opt].long_desc[4],
    ...
    *i_opt = *i_opt + 1;
    ...
    strcpy(options[*i_opt].long_desc[1],
           "rtplot=o   => <string>=(b)ands,(t)ime,(e)nergy,(d)os");
    strcpy(options[*i_opt].long_desc[2],
           "rtplot=l   => <string>=(b)ands,(t)ime,(e)nergy");
