...
void options_maker_nl(struct options_struct options[], int n_options)
{
 int i_opt,i,j;
 ...
 */
 ...
 /* 
  Yambo
 */
 options_yambo_nl(options,&i_opt);
 /* 
  Projects
 */
 options_projects_nl(options,&i_opt);
#endif
