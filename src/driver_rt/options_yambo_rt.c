...
void options_yambo_rt(struct options_struct options[],int *i_opt)
{ 
 char *desc;
 int i_desc=0;
 desc="Self-Energy";
...
void options_projects_rt(struct options_struct options[],int *i_opt)
{
 char *desc;
 int i_desc=0;
 ...
 *i_opt=*i_opt+1;
 ...
 options[*i_opt].bin="yambo_rt yambo_qed";
