...
static struct init_fntc arith_fncts[] = {{"sqrt", gsl_complex_sqrt},
                                         {"exp", gsl_complex_exp},
                                         {"ln", gsl_complex_log},
                                         {"log", gsl_complex_log},
...
static struct init_cnst arith_cnts[] = {{"pi", M_PI},
                                        {"e", M_E},
                                        {"true", 1},
                                        {"t", 1},
                                        {"yes", 1},
...
static char *reserved_symbols[] = {"x", "y", "z", "r", 0};
            ...
            case S_BLOCK:
                if (ptr->value.block->n > 0)
                {
                    for (l = 0; l < ptr->value.block->n; l++)
                    {
                        ...
                        {
                            for (col = 0; col < ptr->value.block->lines[l].n;
                                 col++)
                            {
